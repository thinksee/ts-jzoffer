 ...
 * 假设输入的前序遍历和中序遍历
 */
public class J06ConstructBinaryTree {
    ...
    public static BinaryTreeNode constructCore(int[] preorder, int startPreorder, int endPreorder, int[] inorder, int startInorder, int endInorder) throws Exception{
    ...
    public static int[] postTraversal(BinaryTreeNode root){
